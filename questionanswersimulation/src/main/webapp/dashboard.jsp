...
<body>
	...
	<!-- 	<div class="col-lg-8 col-md-8 mb-12"> -->
			...
			<div class="col-lg-4 col-md-4 mb-4">
				<div class="card">
				<a class="btn btn-primary btn-md waves-effect waves-light" href="ListQuestionsController">List Questions</a>			
				</div>
				
			</div>
 			<div class="col-lg-4 col-md-4 mb-4" style="float: left">
				<div class="card">
				<a class="btn btn-primary btn-md waves-effect waves-light" href="./questionForm.jsp">Ask a question</a>
				</div>
			</div> 
		</div>
<!-- 		</div> -->
